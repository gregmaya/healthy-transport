...
export const STEPS_BUS = [
  ...
  },
  {
    ...
    // both normalised to the shared range [0.020, 0.941].
  ...
  <circle cx="139.0" cy="160.0" r="2.2" fill="#ff6700" fill-opacity="0.8"/>
  <circle cx="139.6" cy="159.8" r="2.2" fill="#ff6801" fill-opacity="0.8"/>
  <circle cx="151.9" cy="153.6" r="2.2" fill="#fc7c25" fill-opacity="0.8"/>
  <circle cx="155.4" cy="152.2" r="2.2" fill="#fb812e" fill-opacity="0.8"/>
  <circle cx="151.1" cy="152.0" r="2.2" fill="#fb812f" fill-opacity="0.8"/>
  <circle cx="119.3" cy="151.9" r="2.2" fill="#fb822f" fill-opacity="0.8"/>
  <circle cx="124.6" cy="151.3" r="2.2" fill="#fb8433" fill-opacity="0.8"/>
  <circle cx="158.4" cy="149.8" r="2.2" fill="#fa893c" fill-opacity="0.8"/>
  <circle cx="195.4" cy="147.9" r="2.2" fill="#f98f47" fill-opacity="0.8"/>
  <circle cx="156.2" cy="147.4" r="2.2" fill="#f9914a" fill-opacity="0.8"/>
  <circle cx="131.9" cy="145.2" r="2.2" fill="#f89857" fill-opacity="0.8"/>
  <circle cx="177.2" cy="144.9" r="2.2" fill="#f79958" fill-opacity="0.8"/>
  <circle cx="200.0" cy="144.3" r="2.2" fill="#f79b5d" fill-opacity="0.8"/>
  <circle cx="163.9" cy="143.4" r="2.2" fill="#f79e62" fill-opacity="0.8"/>
  <circle cx="146.7" cy="143.1" r="2.2" fill="#f79f63" fill-opacity="0.8"/>
  <circle cx="180.2" cy="141.6" r="2.2" fill="#f6a46c" fill-opacity="0.8"/>
  <circle cx="128.2" cy="141.1" r="2.2" fill="#f6a56f" fill-opacity="0.8"/>
  <circle cx="165.0" cy="141.0" r="2.2" fill="#f6a66f" fill-opacity="0.8"/>
  <circle cx="153.4" cy="140.8" r="2.2" fill="#f5a771" fill-opacity="0.8"/>
  <circle cx="156.4" cy="139.8" r="2.2" fill="#f5aa77" fill-opacity="0.8"/>
  <circle cx="152.0" cy="137.7" r="2.2" fill="#f4b083" fill-opacity="0.8"/>
  <circle cx="153.8" cy="137.2" r="2.2" fill="#f4b286" fill-opacity="0.8"/>
  <circle cx="152.7" cy="137.1" r="2.2" fill="#f4b386" fill-opacity="0.8"/>
  <circle cx="161.7" cy="136.6" r="2.2" fill="#f3b489" fill-opacity="0.8"/>
  <circle cx="121.9" cy="136.6" r="2.2" fill="#f3b48a" fill-opacity="0.8"/>
  <circle cx="127.9" cy="134.4" r="2.2" fill="#f2bb96" fill-opacity="0.8"/>
  <circle cx="124.7" cy="133.9" r="2.2" fill="#f2bd99" fill-opacity="0.8"/>
  <circle cx="159.0" cy="133.0" r="2.2" fill="#f2c09e" fill-opacity="0.8"/>
  <circle cx="127.1" cy="130.9" r="2.2" fill="#f0c7ab" fill-opacity="0.8"/>
  <circle cx="146.2" cy="130.5" r="2.2" fill="#f0c8ad" fill-opacity="0.8"/>
  <circle cx="157.6" cy="127.8" r="2.2" fill="#efd1bd" fill-opacity="0.8"/>
  <circle cx="121.2" cy="127.1" r="2.2" fill="#efd4c1" fill-opacity="0.8"/>
  <circle cx="166.2" cy="127.0" r="2.2" fill="#efd4c2" fill-opacity="0.8"/>
  <circle cx="141.0" cy="126.9" r="2.2" fill="#eed4c3" fill-opacity="0.8"/>
  <circle cx="128.5" cy="126.9" r="2.2" fill="#eed4c3" fill-opacity="0.8"/>
  <circle cx="128.2" cy="119.7" r="2.2" fill="#ebebeb" fill-opacity="0.8"/>
  <circle cx="146.5" cy="116.9" r="2.2" fill="#e8e8e8" fill-opacity="0.8"/>
  <circle cx="126.6" cy="116.2" r="2.2" fill="#e7e7e7" fill-opacity="0.8"/>
  <circle cx="161.2" cy="115.0" r="2.2" fill="#e6e6e6" fill-opacity="0.8"/>
  <circle cx="161.2" cy="115.0" r="2.2" fill="#e6e6e6" fill-opacity="0.8"/>
  <circle cx="99.2" cy="114.4" r="2.2" fill="#e5e5e5" fill-opacity="0.8"/>
  <circle cx="150.5" cy="113.7" r="2.2" fill="#e4e4e4" fill-opacity="0.8"/>
  <circle cx="142.4" cy="112.3" r="2.2" fill="#e3e3e3" fill-opacity="0.8"/>
  <circle cx="143.0" cy="112.0" r="2.2" fill="#e2e2e2" fill-opacity="0.8"/>
  <circle cx="116.0" cy="111.3" r="2.2" fill="#e2e2e2" fill-opacity="0.8"/>
  <circle cx="116.0" cy="111.3" r="2.2" fill="#e2e2e2" fill-opacity="0.8"/>
  <circle cx="131.7" cy="111.0" r="2.2" fill="#e1e1e1" fill-opacity="0.8"/>
  <circle cx="103.8" cy="110.2" r="2.2" fill="#e1e1e1" fill-opacity="0.8"/>
  <circle cx="136.0" cy="108.8" r="2.2" fill="#dfdfdf" fill-opacity="0.8"/>
  <circle cx="127.7" cy="108.7" r="2.2" fill="#dfdfdf" fill-opacity="0.8"/>
  <circle cx="128.8" cy="108.3" r="2.2" fill="#dedede" fill-opacity="0.8"/>
  <circle cx="110.9" cy="106.6" r="2.2" fill="#dddddd" fill-opacity="0.8"/>
  <circle cx="133.3" cy="106.6" r="2.2" fill="#dddddd" fill-opacity="0.8"/>
  <circle cx="126.2" cy="106.3" r="2.2" fill="#dcdcdc" fill-opacity="0.8"/>
  <circle cx="117.3" cy="105.0" r="2.2" fill="#dbdbdb" fill-opacity="0.8"/>
  <circle cx="131.6" cy="104.8" r="2.2" fill="#dbdbdb" fill-opacity="0.8"/>
  <circle cx="117.4" cy="104.7" r="2.2" fill="#dbdbdb" fill-opacity="0.8"/>
  <circle cx="116.8" cy="104.4" r="2.2" fill="#dadada" fill-opacity="0.8"/>
  <circle cx="139.4" cy="104.2" r="2.2" fill="#dadada" fill-opacity="0.8"/>
  <circle cx="141.3" cy="104.1" r="2.2" fill="#dadada" fill-opacity="0.8"/>
  <circle cx="147.3" cy="102.7" r="2.2" fill="#d8d8d8" fill-opacity="0.8"/>
  <circle cx="106.1" cy="102.3" r="2.2" fill="#d8d8d8" fill-opacity="0.8"/>
  <circle cx="118.6" cy="100.0" r="2.2" fill="#d5d5d5" fill-opacity="0.8"/>
  <circle cx="146.4" cy="99.9" r="2.2" fill="#d5d5d5" fill-opacity="0.8"/>
  <circle cx="124.3" cy="96.3" r="2.2" fill="#d2d2d2" fill-opacity="0.8"/>
  <circle cx="124.3" cy="96.3" r="2.2" fill="#d2d2d2" fill-opacity="0.8"/>
  <circle cx="149.2" cy="94.8" r="2.2" fill="#d0d0d0" fill-opacity="0.8"/>
  <circle cx="145.3" cy="89.6" r="2.2" fill="#cacaca" fill-opacity="0.8"/>
  <circle cx="134.6" cy="89.4" r="2.2" fill="#cacaca" fill-opacity="0.8"/>
  <circle cx="136.2" cy="88.7" r="2.2" fill="#c9c9c9" fill-opacity="0.8"/>
  <circle cx="141.5" cy="88.4" r="2.2" fill="#c9c9c9" fill-opacity="0.8"/>
  <circle cx="142.3" cy="86.3" r="2.2" fill="#c7c7c7" fill-opacity="0.8"/>
  <circle cx="122.1" cy="79.6" r="2.2" fill="#bfbfc0" fill-opacity="0.8"/>
  <circle cx="138.7" cy="76.2" r="2.2" fill="#b3b8bd" fill-opacity="0.8"/>
  <circle cx="114.8" cy="57.0" r="2.2" fill="#7391b0" fill-opacity="0.8"/>
  <circle cx="115.3" cy="56.2" r="2.2" fill="#708fb0" fill-opacity="0.8"/>
  <circle cx="111.3" cy="55.1" r="2.2" fill="#6d8daf" fill-opacity="0.8"/>
  <circle cx="111.3" cy="55.1" r="2.2" fill="#6d8daf" fill-opacity="0.8"/>
  <circle cx="116.8" cy="41.9" r="2.2" fill="#4072a6" fill-opacity="0.8"/>
  <circle cx="120.2" cy="31.4" r="2.2" fill="#2e67a2" fill-opacity="0.8"/>
  <circle cx="137.3" cy="23.2" r="2.2" fill="#2261a0" fill-opacity="0.8"/>
  <circle cx="119.1" cy="16.6" r="2.2" fill="#185b9d" fill-opacity="0.8"/>
  <circle cx="140.5" cy="15.2" r="2.2" fill="#165a9d" fill-opacity="0.8"/>
  <circle cx="129.9" cy="10.6" r="2.2" fill="#0f569b" fill-opacity="0.8"/>
  <circle cx="134.7" cy="8.5" r="2.2" fill="#0c559b" fill-opacity="0.8"/>
  <!-- X axis -->
