...
export const STEPS_BUS = [
  ...
  <circle cx="139.6" cy="159.7" r="2.2" fill="#ff6801" fill-opacity="0.8"/>
  <circle cx="151.9" cy="153.1" r="2.2" fill="#fc7e29" fill-opacity="0.8"/>
  <circle cx="155.4" cy="151.5" r="2.2" fill="#fb8332" fill-opacity="0.8"/>
  <circle cx="151.1" cy="151.5" r="2.2" fill="#fb8332" fill-opacity="0.8"/>
  <circle cx="119.3" cy="151.4" r="2.2" fill="#fb8333" fill-opacity="0.8"/>
  <circle cx="124.5" cy="150.8" r="2.2" fill="#fa8536" fill-opacity="0.8"/>
  <circle cx="158.4" cy="149.2" r="2.2" fill="#fa8b3f" fill-opacity="0.8"/>
  <circle cx="195.4" cy="147.0" r="2.2" fill="#f8924d" fill-opacity="0.8"/>
  <circle cx="156.1" cy="146.8" r="2.2" fill="#f8934e" fill-opacity="0.8"/>
  <circle cx="131.8" cy="144.0" r="2.2" fill="#f79c5e" fill-opacity="0.8"/>
  <circle cx="177.2" cy="143.8" r="2.2" fill="#f79c5f" fill-opacity="0.8"/>
  <circle cx="200.0" cy="143.1" r="2.2" fill="#f79f63" fill-opacity="0.8"/>
  <circle cx="163.9" cy="141.6" r="2.2" fill="#f6a46c" fill-opacity="0.8"/>
  <circle cx="146.7" cy="141.3" r="2.2" fill="#f6a56e" fill-opacity="0.8"/>
  <circle cx="180.2" cy="140.0" r="2.2" fill="#f5a976" fill-opacity="0.8"/>
  <circle cx="128.1" cy="139.2" r="2.2" fill="#f5ac7a" fill-opacity="0.8"/>
  <circle cx="165.0" cy="139.0" r="2.2" fill="#f5ac7b" fill-opacity="0.8"/>
  <circle cx="153.4" cy="138.8" r="2.2" fill="#f4ad7d" fill-opacity="0.8"/>
  <circle cx="156.4" cy="137.7" r="2.2" fill="#f4b183" fill-opacity="0.8"/>
  <circle cx="151.9" cy="135.2" r="2.2" fill="#f3b992" fill-opacity="0.8"/>
  <circle cx="153.7" cy="134.8" r="2.2" fill="#f2ba94" fill-opacity="0.8"/>
  <circle cx="152.7" cy="134.6" r="2.2" fill="#f2bb95" fill-opacity="0.8"/>
  <circle cx="121.9" cy="134.4" r="2.2" fill="#f2bc97" fill-opacity="0.8"/>
  <circle cx="161.7" cy="134.1" r="2.2" fill="#f2bd98" fill-opacity="0.8"/>
  <circle cx="127.9" cy="132.0" r="2.2" fill="#f1c3a4" fill-opacity="0.8"/>
  <circle cx="124.6" cy="131.2" r="2.2" fill="#f1c6a9" fill-opacity="0.8"/>
  <circle cx="158.9" cy="130.4" r="2.2" fill="#f0c9ae" fill-opacity="0.8"/>
  <circle cx="127.0" cy="127.8" r="2.2" fill="#efd1bd" fill-opacity="0.8"/>
  <circle cx="146.2" cy="127.5" r="2.2" fill="#efd2bf" fill-opacity="0.8"/>
  <circle cx="114.8" cy="127.3" r="2.2" fill="#efd3c0" fill-opacity="0.8"/>
  <circle cx="111.2" cy="127.2" r="2.2" fill="#efd3c1" fill-opacity="0.8"/>
  <circle cx="111.2" cy="127.2" r="2.2" fill="#efd3c1" fill-opacity="0.8"/>
  <circle cx="115.2" cy="126.4" r="2.2" fill="#eed6c5" fill-opacity="0.8"/>
  <circle cx="157.5" cy="124.8" r="2.2" fill="#eddbcf" fill-opacity="0.8"/>
  <circle cx="166.2" cy="123.9" r="2.2" fill="#edded4" fill-opacity="0.8"/>
  <circle cx="121.2" cy="123.9" r="2.2" fill="#edded4" fill-opacity="0.8"/>
  <circle cx="141.0" cy="123.6" r="2.2" fill="#eddfd6" fill-opacity="0.8"/>
  <circle cx="128.5" cy="123.4" r="2.2" fill="#ede0d7" fill-opacity="0.8"/>
  <circle cx="110.8" cy="123.3" r="2.2" fill="#ede0d8" fill-opacity="0.8"/>
  <circle cx="99.1" cy="123.2" r="2.2" fill="#ede1d8" fill-opacity="0.8"/>
  <circle cx="141.3" cy="118.0" r="2.2" fill="#e9e9e9" fill-opacity="0.8"/>
  <circle cx="116.8" cy="117.4" r="2.2" fill="#e8e8e8" fill-opacity="0.8"/>
  <circle cx="147.3" cy="117.1" r="2.2" fill="#e8e8e8" fill-opacity="0.8"/>
  <circle cx="120.1" cy="116.3" r="2.2" fill="#e7e7e7" fill-opacity="0.8"/>
  <circle cx="128.2" cy="115.6" r="2.2" fill="#e6e6e6" fill-opacity="0.8"/>
  <circle cx="146.5" cy="113.0" r="2.2" fill="#e3e3e3" fill-opacity="0.8"/>
  <circle cx="126.5" cy="111.6" r="2.2" fill="#e2e2e2" fill-opacity="0.8"/>
  <circle cx="161.2" cy="111.2" r="2.2" fill="#e2e2e2" fill-opacity="0.8"/>
  <circle cx="161.2" cy="111.2" r="2.2" fill="#e2e2e2" fill-opacity="0.8"/>
  <circle cx="129.8" cy="110.8" r="2.2" fill="#e1e1e1" fill-opacity="0.8"/>
  <circle cx="119.0" cy="110.2" r="2.2" fill="#e0e0e0" fill-opacity="0.8"/>
  <circle cx="149.2" cy="109.8" r="2.2" fill="#e0e0e0" fill-opacity="0.8"/>
  <circle cx="150.4" cy="109.2" r="2.2" fill="#dfdfdf" fill-opacity="0.8"/>
  <circle cx="146.4" cy="107.6" r="2.2" fill="#dedede" fill-opacity="0.8"/>
  <circle cx="115.9" cy="107.5" r="2.2" fill="#dedede" fill-opacity="0.8"/>
  <circle cx="115.9" cy="107.5" r="2.2" fill="#dedede" fill-opacity="0.8"/>
  <circle cx="142.4" cy="107.5" r="2.2" fill="#dedede" fill-opacity="0.8"/>
  <circle cx="122.0" cy="107.2" r="2.2" fill="#dddddd" fill-opacity="0.8"/>
  <circle cx="143.0" cy="107.1" r="2.2" fill="#dddddd" fill-opacity="0.8"/>
  <circle cx="131.7" cy="105.5" r="2.2" fill="#dbdbdb" fill-opacity="0.8"/>
  <circle cx="103.7" cy="105.3" r="2.2" fill="#dbdbdb" fill-opacity="0.8"/>
  <circle cx="137.2" cy="105.0" r="2.2" fill="#dbdbdb" fill-opacity="0.8"/>
  <circle cx="135.9" cy="104.2" r="2.2" fill="#dadada" fill-opacity="0.8"/>
  <circle cx="128.8" cy="103.1" r="2.2" fill="#d9d9d9" fill-opacity="0.8"/>
  <circle cx="140.5" cy="103.0" r="2.2" fill="#d9d9d9" fill-opacity="0.8"/>
  <circle cx="127.7" cy="102.9" r="2.2" fill="#d9d9d9" fill-opacity="0.8"/>
  <circle cx="134.7" cy="102.5" r="2.2" fill="#d8d8d8" fill-opacity="0.8"/>
  <circle cx="133.3" cy="101.7" r="2.2" fill="#d7d7d7" fill-opacity="0.8"/>
  <circle cx="126.2" cy="101.1" r="2.2" fill="#d7d7d7" fill-opacity="0.8"/>
  <circle cx="117.2" cy="99.7" r="2.2" fill="#d5d5d5" fill-opacity="0.8"/>
  <circle cx="117.4" cy="99.3" r="2.2" fill="#d5d5d5" fill-opacity="0.8"/>
  <circle cx="131.6" cy="99.2" r="2.2" fill="#d5d5d5" fill-opacity="0.8"/>
  <circle cx="116.7" cy="99.0" r="2.2" fill="#d4d4d4" fill-opacity="0.8"/>
  <circle cx="138.7" cy="98.7" r="2.2" fill="#d4d4d4" fill-opacity="0.8"/>
  <circle cx="139.4" cy="98.7" r="2.2" fill="#d4d4d4" fill-opacity="0.8"/>
  <circle cx="141.4" cy="96.3" r="2.2" fill="#d2d2d2" fill-opacity="0.8"/>
  <circle cx="106.1" cy="96.2" r="2.2" fill="#d1d1d1" fill-opacity="0.8"/>
  <circle cx="142.2" cy="95.6" r="2.2" fill="#d1d1d1" fill-opacity="0.8"/>
  <circle cx="134.5" cy="94.6" r="2.2" fill="#d0d0d0" fill-opacity="0.8"/>
  <circle cx="136.2" cy="93.7" r="2.2" fill="#cfcfcf" fill-opacity="0.8"/>
  <circle cx="118.6" cy="93.6" r="2.2" fill="#cfcfcf" fill-opacity="0.8"/>
  <circle cx="124.3" cy="93.0" r="2.2" fill="#cecece" fill-opacity="0.8"/>
  <circle cx="124.3" cy="93.0" r="2.2" fill="#cecece" fill-opacity="0.8"/>
  <circle cx="145.3" cy="92.0" r="2.2" fill="#cdcdcd" fill-opacity="0.8"/>
  <!-- X axis -->
